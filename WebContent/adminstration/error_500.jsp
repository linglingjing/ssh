...
<body>
			...
			<li class="has-sub">
				...
				<ul class="sub">
					<li class="has-sub-sub">
						<a href="superAdministrator.html" class=""><span class="sub-menu-text">超级管理员列表</span>
						</a></li>
					<li><a class="" href="addAdministrator.html"><span class="sub-menu-text">添加管理员</span></a></li>
					<li><a class="" href="ordinaryAdministrator.html"><span class="sub-menu-text">普通管理员列表</span></a></li>
				</ul>
			</li>
			<li><a class="" href="userList.html"><i class="fa fa-envelope-o fa-fw"></i> <span class="menu-text">用户管理</span></a></li>
			<li class="has-sub">
				<a href="javascript:;" class="">
				...
				<ul class="sub">
					<li><a class="" href="bookList.html"><span class="sub-menu-text">图书列表</span></a></li>
					<li><a class="" href="addBook.html"><span class="sub-menu-text">添加图书</span></a></li>
				</ul>
			</li>
			<li class="has-sub">
				<a href="javascript:;" class="">
				...
				<ul class="sub">
					<li><a class="" href="orderList.html"><span class="sub-menu-text">订单列表</span></a></li>
					<li><a class="" href="orderHandle.html"><span class="sub-menu-text">处理订单</span></a></li>
				</ul>
			</li>
		</ul>
				<!-- /SIDEBAR MENU -->
	...
	<!-- JQUERY UI-->
	<script src="admin/js/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min.js"></script>
	<!-- BOOTSTRAP -->
